...
Route::resource('sub_teachers', controller: Sub_teacherController::class)->middleware(['auth.type:secretary']);
Route::resource('lectures', controller: LectureController::class)->middleware(['auth.type:teacher']); 
Route::middleware(['auth.type:secretary,teacher,admin'])->group(function (){
...
Route::resource('exams', controller: ExamController::class)->middleware(['auth.type:teacher']);
Route::resource('rating', controller: RatingController::class)->middleware(['auth.type:admin']);
Route::get('/exam/answer-question/{user_id}/{exam_id}',  [ ExamController::class, 'answerQuestion'])
    ->name('exam.answerQuestion')->middleware(['auth.type:teacher']);
Route::resource('questions', controller: QuestionController::class)->middleware(['auth.type:teacher']);
Route::get('/exam/addQuestion/{id}', [QuestionController::class, 'addQuestion'])->name('exam.addQuestion')->middleware(['auth.type:teacher']);

Route::resource('students', controller: StudentController::class)->middleware(['auth.type:student']);
Route::get('/students/ExamInfo/{id}',[StudentController::class, 'information'])->name('student.info')->middleware(['auth.type:student']);
Route::get('/students/questinExam/{id}',[StudentController::class, 'questinExam'])->name('student.questinExam')->middleware(['auth.type:student']);
...
Route::get('/history', [HistoryController::class, 'index'])->name('history')->middleware(['auth.type:admin']);
Route::delete('/history/{history}', [HistoryController::class, 'destroy'])->name('history.destroy')->middleware(['auth.type:admin']);
