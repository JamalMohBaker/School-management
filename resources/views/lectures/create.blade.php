    ...
    <div class="ms-md-1 ms-0">
        <nav>
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active" aria-current="page"> Add Lecteure</li>
            </ol>
        </nav>
    </div>
</div>
<form id="add_lecture">
    ...
    <div class="row gy-3">
        <div class="col-xl-12">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Tiltle Of Lecture">
            <label for="url" class="form-label "> Url Of Lecture </label>
            <input type="text" name="url" class="form-control" id="url" placeholder="Url Of Lecture">
            ...
            <input type="file" class="single-fileupload"  name="filepond" id="attachment">
            ...
            <select class="js-example-basic-single" name="lecture" id="lecture">
                ...
                <option value="{{$sub_teacher->id}}">{{$sub_teacher->description}}</option>
                @endforeach
            </select>
    ...
    function performStore() {
            const formData = new FormData();
               ...
               // الوصول إلى FilePond الحالي بدلاً من إنشاء واحد جديد
                ...
                document.getElementById("add_lecture").reset();
                })
